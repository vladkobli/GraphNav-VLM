...
def generate_launch_description():
    sensors_dir = get_package_share_directory("sensors_bringup")
    ...
    clipseg = Node(
        ...
        parameters=[
            {
                "rgb_topic": "/camera/driver/color/image_raw",
                "depth_topic": "/camera/driver/aligned_depth_to_color/image_raw",
            }
        ],
        arguments=[
            "--ros-args",
        ...
        parameters=[
            {
                ...
                "camera_info_topic": "/camera/driver/aligned_depth_to_color/camera_info",
