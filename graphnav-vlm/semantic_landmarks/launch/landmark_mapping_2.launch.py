...
def generate_launch_description():
    ...
    clipseg = Node(
        ...
        executable="clipseg_depth_node_with_multimasks_2",
        ...
        parameters=[
            {
                ...
                # Keep these false unless debugging per-object masks
                "publish_union_masked_depth": False,
                "publish_per_prompt_masked_depth": False,
                "publish_masked_depth_rviz": False,
    ...
    landmark_logger = Node(
        package="semantic_landmarks",
        executable="masked_depth_landmark_logger_2",
        ...
        parameters=[
            {
                ...
                "write_period_sec": 2.0,
                "samples_window": 15,
                "min_samples_for_yaml": 10,
                "max_landmark_age_sec": 60.0,
            }
        ],
    )
